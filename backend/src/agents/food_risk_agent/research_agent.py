...
OUTPUT
After research is complete, call finish_task with a compact evidence brief in its result field.
This is evidence for the root agent, not a user-facing report.
""".strip(),
)
